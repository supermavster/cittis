...
$row_RecordsetCo = $Conexion->db_exec ('fetch_assoc',$query_RecordsetCo);
$totalRows_RecordsetCo = $Conexion->db_exec('num_rows',$query_RecordsetCo);

$query_RecordsetTus = "SELECT * FROM tipousosuelo";
$row_RecordsetTus = $Conexion->db_exec('fetch_assoc'$query_RecordsetTus);
$totalRows_RecordsetTus = $Conexion->db_exec('num_rows'$query_RecordsetTus);
