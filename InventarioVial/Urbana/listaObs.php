...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  ...
  //select_db($database_Conexion, $Conexion);
...
$row_RecordsetAn = $Conexion->db_exec('fetch_assoc',$query_RecordsetAn);
$totalRows_RecordsetAn = $Conexion->db_exec('num_rows',$query_RecordsetAn);
...
?>
          ...
          <?php
} while ($row_RecordsetObs = fetch_assoc($RecordsetObs));
?>
        </select>
