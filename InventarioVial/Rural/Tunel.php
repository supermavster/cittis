...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tunel (IdSer, IdCal, Anclaje, CentroControl, Iluminacion, Ventilacion, Altura, Telefono) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['IdSer'], "int"),
                       GetSQLValueString($_POST['IdCal'], "int"),
                       GetSQLValueString($_POST['Anclaje'], "text"),
                       GetSQLValueString($_POST['CentroControl'], "text"),
                       GetSQLValueString($_POST['Iluminacion'], "text"),
                       GetSQLValueString($_POST['Ventilacion'], "text"),
...
$query_RecordsetServicio = "SELECT * FROM servicio";
$row_RecordsetServicio = $Conexion->db_exec('fetch_assoc',$query_RecordsetServicio);
$totalRows_RecordsetServicio = $Conexion->db_exec('num_rows',$query_RecordsetServicio);

$query_RecordsetCalzada = "SELECT * FROM calzada";
$row_RecordsetCalzada = $Conexion->db_exec('fetch_assoc',$query_RecordsetCalzada);
$totalRows_RecordsetCalzada = $Conexion->db_exec('num_rows',$query_RecordsetCalzada);
...
<menu class="clearfix">
    ...
    <ul class="main-menu clearfix">
        ...
        <li class="search fa fa-search"></li>
            ...
            <br>
            <br>
            <br><h1><span>Tunel</span></h1>
            <br>
            <br>
            <br>
           
           <img src="images/Tunel.jpg" width="432" height="230"/>
            <br>
<br>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table align="center">
     <tr valign="baseline">
      <td height="104" align="right" nowrap>Calzada N°:</td>
      <td><input type="text" name="IdCal" value="<?php echo $row['IdCal']; ?>" readonly size="32"/></td>
    </tr>
    <tr valign="baseline">
      <td height="79" align="right" nowrap>Servicio:</td>
      <td><select name="IdSer">
      <option value="Seleccione">--Seleccione una opcion--</option>
        <?php 
do {  
?>
        <option value="<?php echo $row_RecordsetServicio['IdSer']?>" ><?php echo $row_RecordsetServicio['Nombre']?></option>
        <?php
} while ($row_RecordsetServicio = mysql_fetch_assoc($RecordsetServicio));
?>
      </select></td><br>
    ...
    <tr valign="baseline">
      <td height="100" align="right" nowrap>Anclaje:</td>
      <td><input type="text" name="Anclaje" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td height="114" align="right" nowrap>Centro Control:</td>
      <td><input type="text" name="CentroControl" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td height="99" align="right" nowrap>Iluminacion:</td>
      <td><input type="text" name="Iluminacion" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td height="88" align="right" nowrap>Ventilacion:</td>
      <td><input type="text" name="Ventilacion" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td height="104" align="right" nowrap>Altura:</td>
      <td><input type="text" name="Altura" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td height="87" align="right" nowrap>Telefono:</td>
