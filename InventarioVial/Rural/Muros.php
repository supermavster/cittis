...
$row_RecordsetMaterialMu = $Conexion->db_exec('fetch_assoc',$query_RecordsetMaterialMu);
$totalRows_RecordsetMaterialMu =$Conexion->db_exec('num_rows',$query_RecordsetMaterialMu);
