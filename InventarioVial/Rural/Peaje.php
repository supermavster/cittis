...
$row_Recordsetrecursos =$Conexion->db_exec('fetch_assoc',$query_Recordsetrecursos);
$totalRows_Recordsetrecursos =$Conexion->db_exec('num_rows',$query_Recordsetrecursos);

$query_RecordsetOperador = "SELECT * FROM operador";
$row_RecordsetOperador =$Conexion->db_exec('fetch_assoc',$query_RecordsetOperador);
$totalRows_RecordsetOperador = $Conexion->db_exec('num_rows',$query_RecordsetOperador);
