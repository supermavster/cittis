...
$row_RecordsetMaterialPo = $Conexion->db_exec('fetch_assoc',$query_RecordsetMaterialPo);
$totalRows_RecordsetMaterialPo =$Conexion->db_exec('num_rows',$query_RecordsetMaterialPo);

$query_RecordsetTipoPonton = "SELECT * FROM tipoponton";
$row_RecordsetTipoPonton =$Conexion->db_exec('fetch_assoc',$query_RecordsetTipoPonton);
$totalRows_RecordsetTipoPonton =$Conexion->db_exec('num_rows',$query_RecordsetTipoPonton);
