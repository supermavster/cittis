...
$row_RecordsetInventario = $Conexion->db_exec('fetch_assoc',$query_RecordsetInventario);
$totalRows_RecordsetInventario = $Conexion->db_exec('num_rows',$query_RecordsetInventario);
