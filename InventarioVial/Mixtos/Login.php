...
$query_RecordsetLog = "SELECT * FROM login";
$RecordsetLog = mysql_query($query_RecordsetLog, $Conexion) or die(mysql_error());
$row_RecordsetLog = mysql_fetch_assoc($RecordsetLog);
$totalRows_RecordsetLog = mysql_num_rows($RecordsetLog);
?>
<?php
...
if (isset($_POST['text1'])) {
  ...
  $LoginRS__query=sprintf("SELECT usuario, password FROM login WHERE usuario=%s AND password=%s",
...
<head>
    ...
    <!-- //Meta-Tags -->
    <!-- Index-Page-CSS -->
    <link rel="stylesheet" href="cssl/style.css" type="text/css" media="all">
    <!-- //Custom-Stylesheet-Links -->
    <!--fonts -->
    <link href="//fonts.googleapis.com/css?family=Mukta+Mahee:200,300,400,500,600,700,800" rel="stylesheet">
    <!-- //fonts -->
    <link rel="stylesheet" href="cssl/font-awesome.css" type="text/css" media="all">
...
<body>
    <h1 class="title-agile text-center">Inventarios viales ittus</h1>
...
<?php
mysql_free_result($RecordsetLog);
?>
