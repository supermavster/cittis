...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO listasuelo (IdCos, IdTus, IdIv) VALUES (%s, %s, %s)",
                       GetSQLValueString($_POST['IdCos'], "int"),
                       GetSQLValueString($_POST['IdTus'], "int"),
                       GetSQLValueString($_POST['IdIv'], "int"));

  mysql_select_db($database_Conexion, $Conexion);
  $Result1 = mysql_query($insertSQL, $Conexion) or die(mysql_error());

  $insertGoTo = "listaSuelo.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_Conexion, $Conexion);
$query_RecordsetCo = "SELECT * FROM costado";
$RecordsetCo = mysql_query($query_RecordsetCo, $Conexion) or die(mysql_error());
$row_RecordsetCo = mysql_fetch_assoc($RecordsetCo);
$totalRows_RecordsetCo = mysql_num_rows($RecordsetCo);

mysql_select_db($database_Conexion, $Conexion);
$query_RecordsetTus = "SELECT * FROM tipousosuelo";
$RecordsetTus = mysql_query($query_RecordsetTus, $Conexion) or die(mysql_error());
$row_RecordsetTus = mysql_fetch_assoc($RecordsetTus);
$totalRows_RecordsetTus = mysql_num_rows($RecordsetTus);
...
?>
			  ...
			  <span class="menu"></span>
				  <div class="top-menu">
							 <ul class="nav navbar-nav cl-effect-14">
                                ...
                                <li><a href="MenuCalzada.php" class="scroll">Siguiente</a></li>
    ...
    <ul class="main-menu clearfix">
        ...
        <li class="search fa fa-search"></li>
            ...
            <br>
            <br>
            <br><h1><span>Usos de suelo</span></h1>
            <br>
            <br>
            
            <img src="images/usosSuelo.jpg" width="398" height="183"/>
            <br>
            <br>
            <div>
<form method="post" name="form2" action="<?php echo $editFormAction; ?>">
  <table align="center">
   <tr valign="baseline">
      <td height="96" align="right" nowrap>Inventario Vial N°:</td>
      <td><input type="text" name="IdIv" value="<?php echo $row ['IdIv'] ?>" readonly size="32"></td>
    </tr>
    <tr valign="baseline">
      <td height="62" align="right" nowrap>Costado:</td>
...
do {  
?>
          <option value="<?php echo $row_RecordsetCo['IdCo']?>" ><?php echo $row_RecordsetCo['nombreCo']?></option>
          <?php
} while ($row_RecordsetCo = mysql_fetch_assoc($RecordsetCo));
?>
        </select>
      <span class="selectRequiredMsg">Seleccione un elemento.</span></span></td>
    <tr>
    <tr valign="baseline">
      <td height="74" align="right" nowrap>Tipo Uso Suelo</td>
...
do {  
?>
          <option value="<?php echo $row_RecordsetTus['IdTus']?>" ><?php echo $row_RecordsetTus['NombreTus']?></option>
          <?php
} while ($row_RecordsetTus = mysql_fetch_assoc($RecordsetTus));
?>
        </select>
      <span class="selectRequiredMsg">Seleccione un elemento.</span></span></td>
    <tr>
...
<p>&nbsp;</p>
<?php
mysql_free_result($RecordsetCo);

mysql_free_result($RecordsetTus);
