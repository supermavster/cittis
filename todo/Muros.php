...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO muro (AnchoCorona, AnchoCimiento, Altura, IdCo, IdMMu) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['AnchoCorona'], "text"),
                       GetSQLValueString($_POST['AnchoCimiento'], "text"),
                       GetSQLValueString($_POST['Altura'], "text"),
                       GetSQLValueString($_POST['IdCo'], "int"),
                       GetSQLValueString($_POST['IdMMu'], "int"));

  mysql_select_db($database_Conexion, $Conexion);
  $Result1 = mysql_query($insertSQL, $Conexion) or die(mysql_error());

  $insertGoTo = "Muros.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_Conexion, $Conexion);
$query_RecordsetMaterialMu = "SELECT * FROM materialmuro";
$RecordsetMaterialMu = mysql_query($query_RecordsetMaterialMu, $Conexion) or die(mysql_error());
$row_RecordsetMaterialMu = mysql_fetch_assoc($RecordsetMaterialMu);
$totalRows_RecordsetMaterialMu = mysql_num_rows($RecordsetMaterialMu);
			  ...
			  <span class="menu"></span>
				  <div class="top-menu">
							 <ul class="nav navbar-nav cl-effect-14">
								...
								<li><a href="Alcantarillas.php" class="scroll">Agregar Alcantarillas</a></li>
...
<menu class="clearfix">
    ...
    <ul class="main-menu clearfix">
        ...
        <li class="search fa fa-search"></li>
            ...
            <br>
            <br>
            <br><h1><span>Muros</span></h1>
            <br>
            <img src="images/Muros.jpg" width="325" height="173"/>
            <br>
            <br>
<br>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table align="center">
   <tr valign="baseline">
      ...
      <td height="119" align="right" nowrap="nowrap">Su Inventario es:</td>
      <td><input type="text" name="IdIv" value="<?php echo $row['IdIv']; ?>" readonly size="32"/></td>
    <tr valign="baseline">
      <td height="119" align="right" nowrap>AnchoCorona:</td>
      <td><input type="text" name="AnchoCorona" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td height="124" align="right" nowrap>AnchoCimiento:</td>
      <td><input type="text" name="AnchoCimiento" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td height="105" align="right" nowrap>Altura:</td>
      <td><input type="text" name="Altura" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td height="92" align="right" nowrap>Costado:</td>
      <td><select name="IdCo">
        <?php 
do {  
?>
...
?>
    ...
    <tr>
    <tr valign="baseline">
      <td height="65" align="right" nowrap>Material Muro:</td>
      <td><select name="IdMMu">
        <?php 
do {  
?>
        <option value="<?php echo $row_RecordsetMaterialMu['IdMMu']?>" ><?php echo $row_RecordsetMaterialMu['NombreMu']?></option>
        <?php
} while ($row_RecordsetMaterialMu = mysql_fetch_assoc($RecordsetMaterialMu));
?>
      </select></td>
    <tr>
    <tr valign="baseline">
...
mysql_free_result($RecordsetMaterialMu);
?>