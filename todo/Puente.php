...
$RecordsetTipopuente = mysql_query($query_RecordsetTipopuente, $Conexion) or die(mysql_error());
$row_RecordsetTipopuente = mysql_fetch_assoc($RecordsetTipopuente);
$totalRows_RecordsetTipopuente = mysql_num_rows($RecordsetTipopuente);

mysql_select_db($database_Conexion, $Conexion);
$query_RecordsetPaso = "SELECT * FROM tipopaso";
$RecordsetPaso = mysql_query($query_RecordsetPaso, $Conexion) or die(mysql_error());
$row_RecordsetPaso = mysql_fetch_assoc($RecordsetPaso);
$totalRows_RecordsetPaso = mysql_num_rows($RecordsetPaso);

mysql_select_db($database_Conexion, $Conexion);
$query_RecordsetSentidoP = "SELECT * FROM sentidocirculacion";
$RecordsetSentidoP = mysql_query($query_RecordsetSentidoP, $Conexion) or die(mysql_error());
$row_RecordsetSentidoP = mysql_fetch_assoc($RecordsetSentidoP);
$totalRows_RecordsetSentidoP = mysql_num_rows($RecordsetSentidoP);
...
<p>&nbsp;</p>
<?php
mysql_free_result($RecordsetTipopuente);

mysql_free_result($RecordsetPaso);

mysql_free_result($RecordsetSentidoP);
