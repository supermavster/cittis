...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO cuneta (Ancho, Revestimiento, IdCo, IdTCu, IdEs, IdLim) VALUES (%s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['Ancho'], "text"),
                       GetSQLValueString($_POST['Revestimiento'], "text"),
                       GetSQLValueString($_POST['IdCo'], "int"),
                       GetSQLValueString($_POST['IdTCu'], "int"),
                       GetSQLValueString($_POST['IdEs'], "int"),
                       GetSQLValueString($_POST['IdLim'], "int"));

  mysql_select_db($database_Conexion, $Conexion);
  $Result1 = mysql_query($insertSQL, $Conexion) or die(mysql_error());

  $insertGoTo = "Cuneta.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_Conexion, $Conexion);
$query_RecordsetTipoCuneta = "SELECT * FROM tipocuneta";
$RecordsetTipoCuneta = mysql_query($query_RecordsetTipoCuneta, $Conexion) or die(mysql_error());
$row_RecordsetTipoCuneta = mysql_fetch_assoc($RecordsetTipoCuneta);
$totalRows_RecordsetTipoCuneta = mysql_num_rows($RecordsetTipoCuneta);
			  ...
			  <span class="menu"></span>
				  <div class="top-menu">
							 <ul class="nav navbar-nav cl-effect-14">
								...
								<li><a href="Peaje.php" class="scroll">Agregar Peaje</a></li>
...
<menu class="clearfix">
    ...
    <ul class="main-menu clearfix">
        ...
        <li class="search fa fa-search"></li>
            ...
            <br>
            <br>
            <br><h1><span>Cuneta</span></h1>
            <br>
            <br>
            <img src="images/Cuneta.jpg" width="367" height="209"/>
            <br>
<br>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table align="center">
   <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td height="117" align="right" nowrap>Ancho:</td>
      <td><input type="text" name="Ancho" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td height="106" align="right" nowrap>Revestimiento:</td>
      <td><input type="text" name="Revestimiento" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td height="72" align="right" nowrap>Costado:</td>
      <td><select name="IdCo">
...
?>
    ...
    <tr>
    <tr valign="baseline">
      <td height="56" align="right" nowrap>Tipo Cuneta:</td>
      <td><select name="IdTCu">
       <option value="Seleccione">--Seleccione una opcion--</option>
        <?php 
do {  
?>
        <option value="<?php echo $row_RecordsetTipoCuneta['IdTcu']?>" ><?php echo $row_RecordsetTipoCuneta['Nombre']?></option>
        <?php
} while ($row_RecordsetTipoCuneta = mysql_fetch_assoc($RecordsetTipoCuneta));
?>
      </select></td>
    <tr>
    <tr valign="baseline">
      <td height="60" align="right" nowrap>Estado:</td>
      <td><select name="IdEs">
       <option value="Seleccione">--Seleccione una opcion--</option>
        <?php 
do {  
...
?>
    ...
    <tr>
    <tr valign="baseline">
      <td height="77" align="right" nowrap>Limpieza:</td>
      <td><select name="IdLim">
       <option value="Seleccione">--Seleccione una opcion--</option>
        <?php 
do {  
?>
...
mysql_free_result($RecordsetTipoCuneta);
