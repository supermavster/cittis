...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO pesaje (IdAp, IdOp) VALUES (%s, %s)",
			  ...
			  <span class="menu"></span>
				  <div class="top-menu">
							 <ul class="nav navbar-nav cl-effect-14">
								...
								<li><a href="Puente.php" class="scroll">Agregar Puente</a></li>
...
<menu class="clearfix">
    ...
    <ul class="main-menu clearfix">
        ...
        <li class="search fa fa-search"></li>
            ...
            <br>
            <br>
            <br><h1><span>Pesaje</span></h1>
            <br>
            <br>
            <br>
            <img src="images/Pesaje.jpg" width="361" height="198"/>
            <br>
<br>
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table align="center">
   <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td height="58" align="right" nowrap>Administrador :</td>
      <td><select name="IdAp">
...
?>
    ...
    <tr>
    <tr valign="baseline">
      <td height="59" align="right" nowrap>Operador:</td>
      <td><select name="IdOp">
       <option value="Seleccione">--Seleccione una opcion--</option>
        <?php 
do {  
