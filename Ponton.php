...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO ponton (Variante, IdMaPo, IdTpo) VALUES (%s, %s, %s)",
                       GetSQLValueString($_POST['Variante'], "text"),
                       GetSQLValueString($_POST['IdMaPo'], "int"),
                       GetSQLValueString($_POST['IdTpo'], "int"));

  mysql_select_db($database_Conexion, $Conexion);
  $Result1 = mysql_query($insertSQL, $Conexion) or die(mysql_error());

  $insertGoTo = "Ponton.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_Conexion, $Conexion);
$query_RecordsetMaterialPo = "SELECT * FROM materialponton";
$RecordsetMaterialPo = mysql_query($query_RecordsetMaterialPo, $Conexion) or die(mysql_error());
$row_RecordsetMaterialPo = mysql_fetch_assoc($RecordsetMaterialPo);
$totalRows_RecordsetMaterialPo = mysql_num_rows($RecordsetMaterialPo);

mysql_select_db($database_Conexion, $Conexion);
$query_RecordsetTipoPonton = "SELECT * FROM tipoponton";
$RecordsetTipoPonton = mysql_query($query_RecordsetTipoPonton, $Conexion) or die(mysql_error());
$row_RecordsetTipoPonton = mysql_fetch_assoc($RecordsetTipoPonton);
$totalRows_RecordsetTipoPonton = mysql_num_rows($RecordsetTipoPonton);
			  ...
			  <span class="menu"></span>
				  <div class="top-menu">
							 <ul class="nav navbar-nav cl-effect-14">
								...
								<li><a href="SumideroRural.php" class="scroll">Agregar Sumidero</a></li>
...
<menu class="clearfix">
    ...
    <ul class="main-menu clearfix">
        ...
        <li class="search fa fa-search"></li>
            ...
            <br>
            <br>
            <br><h1><span>Ponton</span></h1>
            <br>
            <br>
            <img src="images/Ponton.jpg" width="458" height="158"/>
            <br>
<br>
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table align="center">
   <tr valign="baseline">
      <td height="104" align="right" nowrap>Inventario Vial:</td>
      <td><input type="text" name="IdIv" value="<?php echo $row['IdIv']; ?>" readonly size="32"/></td>
    </tr>
    <tr valign="baseline">
      <td height="98" align="right" nowrap>Variante:</td>
      <td><input type="text" name="Variante" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td height="62" align="right" nowrap>Material Ponton:</td>
      <td><select name="IdMaPo">
      <option value="Seleccione">--Seleccione una opcion--</option>
        <?php 
do {  
?>
        <option value="<?php echo $row_RecordsetMaterialPo['IdMaPo']?>" ><?php echo $row_RecordsetMaterialPo['Nombre']?></option>
        <?php
} while ($row_RecordsetMaterialPo = mysql_fetch_assoc($RecordsetMaterialPo));
?>
      </select></td>
    <tr>    
    <tr valign="baseline">
      <td height="64" align="right" nowrap>Tipo Ponton:</td>
      <td><select name="IdTpo">
      <option value="Seleccione">--Seleccione una opcion--</option>
        <?php 
do {  
?>
        <option value="<?php echo $row_RecordsetTipoPonton['IdTpo']?>" ><?php echo $row_RecordsetTipoPonton['Nombre']?></option>
        <?php
} while ($row_RecordsetTipoPonton = mysql_fetch_assoc($RecordsetTipoPonton));
?>
      </select></td>
    <tr>    
    <tr valign="baseline">
...
<p>&nbsp;</p>
<?php
mysql_free_result($RecordsetMaterialPo);

mysql_free_result($RecordsetTipoPonton);
?>
