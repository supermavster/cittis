...
// Queries
$sql = "SELECT Nombre AS name FROM estructuraalcantarilla ";
$data['option'][++$count] = self::getValuesSQL($sql);

$sql = "SELECT Nombre AS name FROM tipoalcantarilla ";
$data['option'][++$count] = self::getValuesSQL($sql);

$sql = "SELECT Nombre AS name FROM materiatuberia ";
$data['option'][++$count] = self::getValuesSQL($sql);
    ...
    <div class="row justify-content-center">
            <div class="col-lg-12">
                <table class="col-lg-12">
                    ...
                    <tr>
                        <td>Estructura de la Alcantarilla:</td>
                        <td>
                            <div class="dropdown">
