                        ...
                        <td>
                            <div class="dropdown">
                              <select id="typeID" name="typeID" class="btn btn-secondary dropdown-toggle">
                                    ...
                                    <option class="dropdown-item" value="Anden">Anden </option>
                                    <option class="dropdown-item" value="Calzada">Calzada</option>                                                   
                              </select>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>Calzadas de Parqueo:</td>
                        <td>
                            <div class="form-group">
                                <input class="form-control" name="idInventory" id="idInventory" placeholder="Ingrese su inventario"
                                       type="text">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="dropdown">
                              <select id="typeID" name="typeID" class="btn btn-secondary dropdown-toggle">
                                    <option class="dropdown-item" selected>Seleccione...</option>         
                                  <option class="dropdown-item" value="Paralela">Paralela</option>
                                  <option class="dropdown-item" value="Parvial">Par Vial</option>
                                  <option class="dropdown-item" value="Noaplica">No Aplica</option>
                              </select>
                            </div>
                        </td>
                    </tr>
