...
$RecordsetServicio = mysql_query($query_RecordsetServicio, $Conexion) or die(mysql_error());
$row_RecordsetServicio = mysql_fetch_assoc($RecordsetServicio);
$totalRows_RecordsetServicio = mysql_num_rows($RecordsetServicio);
...
<p>&nbsp;</p>
<?php
mysql_free_result($RecordsetServicio);
