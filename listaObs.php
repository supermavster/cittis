...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO listaobstaculos (IdAn, IdO) VALUES (%s, %s)",
                       GetSQLValueString($_POST['IdAn'], "int"),
                       GetSQLValueString($_POST['IdO'], "int"));

  mysql_select_db($database_Conexion, $Conexion);
  $Result1 = mysql_query($insertSQL, $Conexion) or die(mysql_error());

  $insertGoTo = "listaObs.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_Conexion, $Conexion);
$query_RecordsetAn = "SELECT * FROM anden";
$RecordsetAn = mysql_query($query_RecordsetAn, $Conexion) or die(mysql_error());
$row_RecordsetAn = mysql_fetch_assoc($RecordsetAn);
$totalRows_RecordsetAn = mysql_num_rows($RecordsetAn);
...
// realizamos la conexión a la base de datos
  ...
  $sql = "SELECT MAX(IdAn) AS IdAn FROM anden";
...
?>
			  ...
			  <span class="menu"></span>
				  <div class="top-menu">
							 <ul class="nav navbar-nav cl-effect-14">
                                ...
                                <li><a href="Separador.php" class="scroll">Agregar Separador</a></li>
    ...
    <ul class="main-menu clearfix">
        ...
        <li class="search fa fa-search"></li>
            ...
            <br>
            <br>
             <br><h1><span>Obstaculos</span></h1>
            <br>
            <br>
            <br>
            <img src="images/Obstaculos.jpg" width="374" height="282"/>
            <br>
            <br>
            <div>
<form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
  <table align="center">
    <tr valign="baseline">
      <td height="141" align="right" nowrap="nowrap">Anden:</td>
      <td><input type="text" name="IdAn" value="<?php echo $row['IdAn']?>" readonly size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td height="63" align="right" nowrap="nowrap">Obstaculos:</td>
...
do {  
?>
          <option value="<?php echo $row_RecordsetObs['IdO']?>" ><?php echo $row_RecordsetObs['nombreO']?></option>
          <?php
} while ($row_RecordsetObs = mysql_fetch_assoc($RecordsetObs));
?>
        </select>
